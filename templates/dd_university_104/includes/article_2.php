...
<div class=" bd-postimage-1 bd-no-margins">
    ...
    <?php if ($caption): ?>
    <div class=" bd-container-50 bd-tagstyles bd-bootstrap-btn bd-btn-default ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
...
?>
<div class=" bd-postcontent-2 bd-tagstyles bd-custom-blockquotes bd-bootstrap-btn bd-btn-default bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
