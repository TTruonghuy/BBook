...
?>
 ...
 bd-icon-9 bd-icon "></span>
    ...
    <span class=" bd-container-6 bd-tagstyles bd-bootstrap-btn bd-btn-default">
        <?php echo $totalPrice; ?>
    </span>
</div>
 ...
 col-md-4">
    <div class="bd-layoutcolumn-4 bd-column" ><div class="bd-vertical-align-wrapper"><a href="<?php echo $cartHref; ?>" class=" btn   btn-default">
    <?php echo $cartText; ?>
</a></div></div>
</div>
 ...
 col-md-8">
    <div class="bd-layoutcolumn-5 bd-column" ><div class="bd-vertical-align-wrapper"><a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=checkout_task'); ?>" class=" btn   btn-default">
