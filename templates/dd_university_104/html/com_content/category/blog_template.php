...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-192 bd-tagstyles bd-bootstrap-btn bd-btn-default">
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-198 bd-tagstyles bd-bootstrap-btn bd-btn-default">
...
<?php if ($pageHeading) : ?>
    <h2 class=" bd-container-21 bd-tagstyles bd-bootstrap-btn bd-btn-default"><?php echo $pageHeading; ?></h2>
<?php endif; ?>


<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-103 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-121 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryInfo; ?>
</div>
<?php endif; ?>
...
<?php if ($pageHeading) : ?>
    <h2 class=" bd-container-18 bd-tagstyles bd-bootstrap-btn bd-btn-default"><?php echo $pageHeading; ?></h2>
<?php endif; ?>


<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-91 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-93 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryInfo; ?>
</div>
<?php endif; ?>
...
<?php if ($pageHeading) : ?>
    <h2 class=" bd-container-24 bd-tagstyles bd-bootstrap-btn bd-btn-default"><?php echo $pageHeading; ?></h2>
<?php endif; ?>


<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-79 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-83 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryInfo; ?>
</div>
<?php endif; ?>
...
<?php if ($pageHeading) : ?>
    <h2 class=" bd-container-27 bd-tagstyles bd-bootstrap-btn bd-btn-default"><?php echo $pageHeading; ?></h2>
<?php endif; ?>


<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-86 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-88 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    <?php echo $categoryInfo; ?>
</div>
<?php endif; ?>
