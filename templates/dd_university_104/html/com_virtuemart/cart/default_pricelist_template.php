...
<tr <?php if ($index % 2 === 0): ?> class="alt" <?php endif ?>>
	...
	<td>
        ...
        <div class=" bd-container-42 bd-tagstyles bd-bootstrap-btn bd-btn-default">
            <button class=" btn   btn-default" type="submit" name="updatecart.<?php echo $pkey ?>" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" >
...
<tr>
    <td colspan="<?php echo VmConfig::get ('show_tax') ? 9 : 8; ?>">
        ...
        ?>
        <div class=" bd-container-42 bd-tagstyles bd-bootstrap-btn bd-btn-default">
        <a class=" btn   btn-default" href="<?php echo $href; ?>" >
            <span>
                <span>
                    <?php echo $text; ?>
                </span>
