...
<div class=" bd-products"  >
    ...
    <div class=" bd-container-52 bd-tagstyles bd-bootstrap-btn bd-btn-default">
...
<div class=" bd-productprice-3 product-prices">
    ...
    if ($productItems->productPrice->show_prices == '1') {
        ...
        ?>
        <a class="ask-a-question  btn   btn-default" href="<?php echo $askquestion_url; ?>" rel="nofollow" >
...
<div class=" bd-pricetext-10">
    ...
    <span class=" bd-container-30 bd-tagstyles bd-bootstrap-btn bd-btn-default salesPrice">
...
<div class=" bd-pricetext-11">
    ...
    <span class=" bd-container-31 bd-tagstyles bd-bootstrap-btn bd-btn-default basePrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-2 bd-no-margins btn   btn-default';
    ?>
...
<div class=" bd-pricetext-13">
    ...
    <span class=" bd-container-33 bd-tagstyles bd-bootstrap-btn bd-btn-default basePrice">
        <?php echo $oldPriceObj['html']; ?>
    </span>
</div>
<?php endif; ?>
...
<div class=" bd-pricetext-12">
    ...
    <span class=" bd-container-32 bd-tagstyles bd-bootstrap-btn bd-btn-default salesPrice">
        <?php echo $regularPriceObj['html']; ?>
    </span>
</div>
<?php endif; ?>
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        // todo output customfields
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-3 btn   btn-default';
    ?>
    <?php if (!VmConfig::get('use_as_catalog', 0)) : ?>
        <?php
            $quantity = 1;
