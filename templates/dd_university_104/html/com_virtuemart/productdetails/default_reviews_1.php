...
<div class=" bd-productreviews-1">
    <?php if ($this->showReview):	?>
        <div class=" bd-container-39 bd-tagstyles bd-bootstrap-btn bd-btn-default">
    ...
    <form method="post" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $this->product->virtuemart_product_id . '&virtuemart_category_id=' . $this->product->virtuemart_category_id); ?>" name="reviewForm" id="reviewform">
            ...
            ?>
            <div class=" bd-container-40 bd-tagstyles bd-bootstrap-btn bd-btn-default">
                <h4>
    ...
    <?php endfor; ?>
            ...
            <div class="review-button">
                <input class=" btn   btn-default" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>" value="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>"/>
            </div>
            <?php
            } else {
