...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-4 bd-no-margins btn   btn-default';
    ?>
...
<div class=" bd-tabinformationcontrol-2 tabbable" data-responsive="true">
    ...
    <div class=" bd-container-38 bd-tagstyles bd-bootstrap-btn bd-btn-default tab-content">
    ...
    <div class=" bd-container-43 bd-tagstyles bd-bootstrap-btn bd-btn-default accordion-content"></div>
</div>
    </div>
</div>
<?php echo $jsContent; ?>
